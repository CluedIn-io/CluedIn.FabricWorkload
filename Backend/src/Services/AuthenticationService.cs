...
namespace Boilerplate.Services
{
    public class AuthenticationService : IAuthenticationService
    {
        ...
        public Task<TokenCredential> GetTokenCredential(AuthorizationContext authorizationContext)
        {
            var credential = new OnBehalfOfCredential(
                authorizationContext.TenantObjectId.ToString(),
                _clientId,
                _clientSecret,
                authorizationContext.OriginalSubjectToken);

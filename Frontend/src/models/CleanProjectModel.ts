...
export interface CleanProjectItemMetadata {
    inputFilePath: string;
    inputFileLakehouse: ItemReference;
    outputFilePath: string;
    outputFileLakehouse: ItemReference;
    ...
    setupCleanProjectJobId: string;
    cleanInFabricJobId: string;
}
...
export interface CleanProjectItemClientMetadata extends CleanProjectItemMetadata {
    inputFileLakehouse: GenericItem;
    outputFileLakehouse: GenericItem;
}

// Represents the item-specific payload passed with the  CreateItem request
export interface CreateItemPayload {
    cleanProjectItemMetadata?: CleanProjectItemMetadata;
}
...
export interface ItemPayload {
    cleanProjectItemMetadata?: CleanProjectItemClientMetadata;
}
...
export interface CluedInConnection {
    organizationName: string;
    domain: string;
    userEmail: string;
    userPassword: string;

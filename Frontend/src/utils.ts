...
const cleanProjectItemType = sampleWorkloadName + ".CleanProjectItem";
...
export const cleanProjectJobTypeDisplayNames: Record<string, string> = {
    [cleanProjectItemType + ".SetupCleanProject"]: 'Setup Clean Project',
    [cleanProjectItemType + ".CleanInFabric"]: 'Clean In Fabric',
};
